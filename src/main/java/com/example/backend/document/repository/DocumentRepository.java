...
public interface DocumentRepository extends JpaRepository<Document, Long> {
    ...
    @Query("SELECT d.id, d.fileName, d.createdAt, d.status, d.requestName, s.expiredAt " +
            "FROM Document d " +
    ...
    @Query("SELECT d.id, d.fileName, d.createdAt, d.status, m.name, d.requestName, s.expiredAt " +
            "FROM Document d " +
            "JOIN d.member m " +
